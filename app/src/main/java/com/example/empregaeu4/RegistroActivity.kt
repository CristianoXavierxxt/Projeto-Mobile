...
import com.example.empregaeu4.databinding.ActivityRegistroBinding
...
class RegistroActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btRegistro.setOnClickListener {
            ...
            if(empNome.isEmpty()){
                edNomeRegistro.error = "Por favor insira um nome"
            }

            if(empSenha.isEmpty()){
                edNomeRegistro.error = "Por favor insira uma senha"
            }

            if(empEmail.isEmpty()){
                edNomeRegistro.error = "Por favor insira um email"
            }
